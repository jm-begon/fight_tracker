...
class Blinded(Condition):
    def long_repr(self):
        return super().long_repr().add_children(
...
class Deafened(Condition):
    def long_repr(self):
        return super().long_repr().add_child("a deafened creature can’t hear and automatically fails any ability check "
...
class Dead(Unconscious):
    def long_repr(self):
        return super().long_repr().add_children(
            "a dead creature cannot be played anymore"
        )
...
class Exhausted(Condition):
    ...
    def __eq__(self, other):
        return super(Exhausted, self).__eq__(other) and \
